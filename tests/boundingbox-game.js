(function() {
    ...
    //world.makeEntity(groundTemplate, { width: 700, x: 240, y:600 });
    
    world.makeGlyphs(groundTemplate, { x: 1, y:  605,
        text: 'WALKTHRUWALKTHRUWALKTHRU', fontSize: 48, boundingBoxType: BOX });
